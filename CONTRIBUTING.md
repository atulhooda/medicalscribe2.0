# Contributing to EngageoScribe

Thanks for your interest in contributing to EngageoScribe.

EngageoScribe is an MIT-licensed, local-first, open-source AI medical scribe.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/EngageoScribe.git
   cd EngageoScribe
   ```
...
- Check the [Trello board](https://trello.com/b/9ytGVZU4/engageoscribe) for current priorities
...
- Tag @engageo for maintainer attention
