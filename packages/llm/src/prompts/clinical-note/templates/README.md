...
This directory contains markdown templates for clinical note generation. Templates define the structure and formatting of notes produced by EngageoScribe.
