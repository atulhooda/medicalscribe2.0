...
"""
PyInstaller spec file for EngageoScribe Python backend.
...
Usage:
    ...
    pyinstaller engageoscribe-backend.spec

The bundled executable will be in dist/engageoscribe-backend/
"""
